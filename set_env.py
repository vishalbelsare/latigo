...
if not path.exists(filename):
    ...
    local_config={
        ...
        "LATIGO_SENSOR_DATA_CONNECTION": "THE CONNECTION STRING FOR THE SENSOR DATA",
        "LATIGO_PREDICTION_STORAGE_CONNECTION": "THE CONNECTION STRING FOR THE PREDICTION STORAGE",
